$(document).ready(function () {
    ...
    $('#condicion').on('change', function() {
        switch ($(this).val()) {
            case '1':
                $(this).addClass('border-success').removeClass('border-warning border-danger');
                break;
            case '2':
                $(this).addClass('border-warning').removeClass('border-success border-danger');
                break;
            case '3':
                $(this).addClass('border-danger').removeClass('border-success border-warning');
                break;
        }
    });
